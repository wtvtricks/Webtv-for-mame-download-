...
ROM_START( wtv1sony )
	...
	ROM_LOAD("bootrom.o", 0x000000, 0x200000, CRC(71C321DB) SHA1(6A39E064FB2312D70728B8105DE990762226BD07)) /* pre-decoded; from archival efforts of the WebTV update servers */
